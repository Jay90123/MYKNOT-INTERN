...
//     try {
//       await fetch(
//         "http://localhost:5000/api/themes/createtheme",
//         {
//           method: "POST",
//           body: JSON.stringify({
//             img: imgurl,
...
//     try {
//       await fetch("http://localhost:5000/api/img/upload", {
//         method: "POST",
...
export default function ThemesForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/sendThemesData', theme);
